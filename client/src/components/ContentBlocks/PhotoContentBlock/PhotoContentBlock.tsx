...
const PhotoContentBlock: React.FC<IPhotoContentBlockProps> = ({ contentBlock, onChange, onPhotoSave, isInEditMode }) => {
    ...
    <Style.ContentBlockHolder>
      ...
      <S.PhotoContentBlockImgWrapper>
        <FileUploader
          ...
          name='photo'
          value={isInEditMode && !isPhotoChanged ? `${BASE_URL}/file/download/photo?id=${content.photo}` : photoBlob}
          margin='0'
        />
      </S.PhotoContentBlockImgWrapper>
      <Button
