...
import * as S from '@src/pages/CreateInterviewPage/ContentBlocks/style';
import { IVideoContentBlockProps } from '@src/pages/CreateInterviewPage/ContentBlocks/VideoContentBlock/types';
import Input from '@src/components/UI/Input/Input';
import ErrorMsg from '@src/components/UI/ErrorMsg/ErrorMsg';
import { ContentBlockIframe } from '@src/pages/CreateInterviewPage/ContentBlocks/style';
