...
import { IPhotoContentBlockProps } from '@src/pages/CreateInterviewPage/ContentBlocks/PhotoContentBlock/types';
import * as Style from '@src/pages/CreateInterviewPage/ContentBlocks/style';
